...
<body>
	...
	{
		$q=mysqli_query($db,"SELECT first, last, username, email, mobile FROM `student` where username like '%$_POST[search]%'");
	...
	{
		$res=mysqli_query($db,"SELECT first, last, username, email, mobile FROM `student` ORDER BY student.first ASC ;");
